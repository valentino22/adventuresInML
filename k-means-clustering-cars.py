...
dataset = dataset[dataset.columns].apply(pd.to_numeric, errors='coerce') # coerce means that invalid parsing will be set as NaN
cars = dataset[dataset.columns[0:-1]]
cars
sns.heatmap(cars.corr()) # show correlated values
